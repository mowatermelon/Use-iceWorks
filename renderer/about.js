...
var App = __webpack_require__(685);
...
function (_Component) {
  ...
  function About(props) {
    ...
    _this.openLink = function (event) {
      ...
      _this.remote.shell.openExternal(link.href);

      event.preventDefault();
    };

    _this.remote = external_electron_["remote"];
    _this.state = {
      version: external_electron_["remote"].app.getVersion()
    };
    return _this;
  }
  ...
  _createClass(About, [{
    ...
    value: function render() {
      return react_default.a.createElement("div", {
        ...
        className: "appname"
      }, react_default.a.createElement("b", null, appName)), react_default.a.createElement("div", {
        className: "version"
      }, "\u7248\u672C ", this.state.version), react_default.a.createElement("div", {
        className: "copyright"
...
var renderEntry = react_default.a.createElement(pages_About_About);
