      ...
      <Layout
        ...
        className={cx(
          `ice-design-custom-layout-${theme}`,
          {
            ...
            // 'ice-design-header-fixed': <%= header.fixed || false %>,
            // 'ice-design-footer-fixed': <%= footer.fixed || false %>,
          }
        )}
      >
        <% if (!header.disabled ) { -%>
        ...
        <Layout.Section
          ...
          <% } -%>
          className={cx({
            'ice<%= kebabLayoutName -%>-main-section': true,
        ...
        >
          ...
          <Layout.Main
            ...
            scrollable
            <% } -%>
          >{this.props.children}</Layout.Main>
        </Layout.Section>
        <% if (!footer.disabled) { -%>
        <Footer className={cx({
